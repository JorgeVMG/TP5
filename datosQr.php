...
<body >
    ...
    tipo.addEventListener('change', () => {
        ...
        if (valor == "texto") {
            ...
            campo.innerHTML = "<label for='name' class='form-label'>Ingrese nombre de usuario:</label><input type='text' name='name' class='form-control' required><label for='password' class='form-label'>Ingrese la contraseña:</label><input type='password' name='password' class='form-control' required>";
        }
    });
  </script>
</body>
